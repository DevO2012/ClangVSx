...
namespace ClangVSx
{
  ...
  public class CVXConnect : IDTExtensibility2, IDTCommandTarget
  {
    ...
    protected void cvxCompileFile_menuop(object CommandBarControlObj, ref bool handled, ref bool cancelDefault)
    {
      ...
      {
        MessageBox.Show(
            "Clang cannot compile files of this type " + _applicationObject.ActiveDocument.Kind + " unrecognized code file (" +
    ...
    protected void cvxDasmnFile_menuop(object CommandBarControlObj, ref bool handled, ref bool cancelDefault)
    {
      ...
      {
        MessageBox.Show(
            "Clang cannot emit assembly files of this type " + _applicationObject.ActiveDocument.Kind + " unrecognized code file (" +
            _applicationObject.ActiveDocument.Language + ")", "ClangVSx");
      }
    }
    ...
    protected void cvxPreProFile_menuop(object CommandBarControlObj, ref bool handled, ref bool cancelDefault)
    {
      ...
      {
        MessageBox.Show(
            "Clang cannot preprocess files of this type " + _applicationObject.ActiveDocument.ProjectItem.Kind + "unrecognized code file (" +
            _applicationObject.ActiveDocument.Language + ")", "ClangVSx");
      }
    }
